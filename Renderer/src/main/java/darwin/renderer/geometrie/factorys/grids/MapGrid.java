...
public class MapGrid
{
    ...
    public MapGrid(int w, int h, int tessfactor) {
        ...
        final Element pos = new Element(GLSLType.VEC2, "Position");
        final Element tex = new Element(GLSLType.VEC2, "TexCoord");
        final Element tex2 = new Element(GLSLType.VEC2, "TexCoordLocal");
