...
public class RenderBuffer
{
    ...
    public interface RenderBufferFactory
    {
        ...
        public RenderBuffer create(int width, int height, int texformat);

        public RenderBuffer create(int samples, int width, int height, int texformat);
    }
    ...
    @AssistedInject
    public RenderBuffer(GLAutoDrawable drawable, @Assisted int id)
    {
     ...
     * <p/>
     * @param gl        <br> Der GL Context in dem der RenderBuffer erzeugt wird
     *                  <br>
     * @param width     <br> Breite = Anzahl der Pixel pro Zeile <br> muss als
     *                  Wert 2^n + 2 * border f�r n Integerwerte haben. <br>
     ...
     *                  GL_SLUMINANCE8_ALPHA8, GL_SRGB, GL_SRGB8, GL_SRGB_ALPHA
     *                  oder GL_SRGB8_ALPHA8.
     * <p/>
     */
    @AssistedInject
    public RenderBuffer(GLAutoDrawable drawable, GLClientConstants constants,
            @Assisted int width, @Assisted int height, @Assisted int texformat)
    {
        this(drawable, constants, 0, width, height, texformat);
    }
     ...
     *                  * border f�r n Integerwerte haben <br>
     * @param texformat <br> eine der folgenden symbolischen Konstanten : <br>
     *                  GL_STENCIL_INDEX<1,4,8,16>_EXT, GL_COMPRESSED_RGB,
     *                  GL_COMPRESSED_RGBA, GL_DEPTH_COMPONENT,
     *                  GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT24,
     *                  GL_DEPTH_COMPONENT32, GL_R3_G3_B2, GL_RGB, GL_RGB4,
     *                  GL_RGB5, GL_RGB8, GL_RGB10, GL_RGB12, GL_RGB16, GL_RGBA,
    ...
    @AssistedInject
    public RenderBuffer(GLAutoDrawable drawable, GLClientConstants constants,
            @Assisted int samples, @Assisted int width,
            @Assisted int height, @Assisted int texformat)
    {
        this.drawable = drawable;
    ...
    private void bind()
    {
        drawable.getGL().glBindRenderbuffer(GL2ES2.GL_RENDERBUFFER, id);
    }
    ...
    public void delete()
    {
        drawable.getGL().glDeleteRenderbuffers(1, new int[]{id}, 0);
    }
}
