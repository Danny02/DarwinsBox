...
public class BufferObject
{
    ...
    public enum Type
    {
        ...
        STATIC,
        /**
         * You will specify or modify the data repeatedly, and use it repeatedly after each time you do this.
         */
        DYNAMIC;
    ...
    public enum Usage
    {
        ...
        READ,
        /**
         * The data is generated by GL, and copied into the BO to be used for rendering.
         */
        COPY;
    }
...
//        gl = (GL2GL3) GLProxy.newInstance(gl);
     ...
     * @param data
     * data which should be written to the buffer
     * @param usage
     * Buffer usage type
     */
    ...
    /**
     * same usage as bufferData(...), but it allocates the memory with <b>null</b>
     * and uploads the data with bufferSubData. This is a common driver optimization
     * for frequent data uploading to the same buffer.
     * @param data
     * @param type
     * @param usage
     */
     ...
     * <br><br><i>glBufferData with null as data</i></br></br>
     * @param bsize
     * memory size in bytes which should be allocated
     * @param usage
     * Buffer usage type
     */
    ...
    /**
     * overwrites a specified data block,
     * enough memory must already be allocated in the buffer
     * @param offset
     * @param data
     */
